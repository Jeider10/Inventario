                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('cliente.index') }}" class="btn btn-sm btn-primary"><i class="fas fa-arrow-circle-left"></i> Volver</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="tipo_documento">Tipo_Documento</label>
                                        <input type="text" id="" class="form-control" name="tipo_documento" placeholder="Ingrese su tipo_documento" value="">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="nombres">Nombres</label>
                                        <input type="text" id="" name="nombres" class="form-control" placeholder="Escriba Nombre">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="apellidos">Apellidos</label>
                                        <input type="text" id="" name="apellidos" class="form-control" placeholder="Escriba Apellido">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" id="" name="ciudad" class="form-control" placeholder="Escriba Su Ciudad">
                                    </div>
                                <div class="form-group">
